...
namespace Manero.Tests
{
    public class TagsServiceTests
    {
        ...
        //needs to be fixed, does not succeed for now
        [Fact]
        public void GetTag_ShouldReturnCorrectTag()


        {
            // Arrange
            var contextMock = new Mock<ProductDbContext>();
            var service = new TagsService(contextMock.Object);

            // Act
            var result = service.GetTag("Sale");
