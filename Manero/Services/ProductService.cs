...
public class ProductService
{
    ...
    public ProductService()
    {
        ...
        {
            new ProductEntity { Id = 1, ProductName = "Green Shoe", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 12 , ProductRating = 5, ProductTag = "new", Categories = new List<string> {"Women", "Shoes", "New" } },
            new ProductEntity { Id = 2, ProductName = "Forest Shoe", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 29 , ProductRating = 3, ProductTag = "top", Categories = new List<string> {"Men", "Shoes", "Top" }},
            new ProductEntity { Id = 3, ProductName = "White Shoe", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 35 , ProductRating = 5, ProductTag = "sale", Categories = new List<string> {"Women", "Shoes", "Sale" }},
            new ProductEntity { Id = 4, ProductName = "Black Shoe", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 12 , ProductRating = 3, ProductTag = "", Categories = new List<string> {"Women", "Shoes", "BestSellers" }},

            new ProductEntity { Id = 5, ProductName = "Green Bag", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 11 , ProductRating = 2, ProductTag = "new", Categories = new List<string> {"Women", "Bag", "New" } },
            new ProductEntity { Id = 6, ProductName = "Forest Bag", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 39 , ProductRating = 1, ProductTag = "top", Categories = new List<string> {"Men", "Bag", "Top" }},
            new ProductEntity { Id = 7, ProductName = "White Scarf", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 32 , ProductRating = 4, ProductTag = "sale", Categories = new List<string> {"Women", "Scarf", "Sale" }},
            ...
            new ProductEntity { Id = 9, ProductName = "Blue Bag", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 11 , ProductRating = 2, ProductTag = "new", Categories = new List<string> {"Women", "BestSeller", "New" } },
            new ProductEntity { Id = 10, ProductName = "Yellow Bag", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 39 , ProductRating = 1, ProductTag = "top", Categories = new List<string> {"Men", "Bag", "FeaturedProducts", "Top" }},
            new ProductEntity { Id = 11, ProductName = "Black Scarf", ProductDescription = "Amet amet Lorem eu consectetur in deserunt nostrud dolor culpa ad sint amet. Nostrud deserunt consectetur culpa minim mollit veniam aliquip pariatur exercitation ullamco ea voluptate et. Pariatur ipsum mollit magna proident nisi ipsum.", ProductPrice = 32 , ProductRating = 4, ProductTag = "sale", Categories = new List<string> {"Women", "Scarf", "TopProducts", "Sale" }},
